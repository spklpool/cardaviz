class StakePoolPerformanceChart {
    ...
    resetLegend() {
        ...
        this.legend_home = null;
        this.legend_back_arrow = null;
    }
    ...
    drawLegend(legend_x, legend_y, highest_lifetime_luck, lowest_lifetime_luck, current_lifetime_luck, ticker) {
        if (!this.legend_initialized) {
            ...
            this.legend_home = this.draw_home();
            this.legend_back_arrow = this.draw_back_arrow();
        ...
        this.legend_back_arrow.position = new Point(legend_x + (this.legend_back_arrow.bounds.width / 2) + 20 * this.paper.view.pixelRatio, this.legend_home.position.y + (this.legend_home.bounds.height / 2) + (20 * this.paper.view.pixelRatio));
