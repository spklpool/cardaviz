class StakePoolPerformanceChart {
    ...
    drawLegend(legend_x, legend_y, highest_lifetime_luck, lowest_lifetime_luck, current_lifetime_luck, ticker) {
        ...
        this.legend_back_arrow.position = new Point(legend_x + (this.legend_back_arrow.bounds.width / 2) + 38, this.legend_home.position.y + (this.legend_home.bounds.height / 2) + (20 * this.paper.view.pixelRatio));
